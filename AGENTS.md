...
- Never use a complete UI screenshot or flattened whole-screen map as app content. Build each screen from independently positioned React components and individual art assets; game state, level nodes, controls, text, and interaction must remain live code.
